...
| Documento | Contenido |
|---|---|
| [Memoria técnica global](https://github.com/davidreyna1974/almacenes/blob/main/docs/memoria_tecnica_global_proyecto.md) | Visión del sistema, stack, decisiones arquitectónicas, contratos de integración, RBAC transversal, estado del proyecto, lecciones globales (L29–L35). |
...
> [memoria técnica global](https://github.com/davidreyna1974/almacenes/blob/main/docs/memoria_tecnica_global_proyecto.md).
...
| Protocolo de 4 fases + seguridad server-side | Ver la sección de QA de la [memoria técnica global](https://github.com/davidreyna1974/almacenes/blob/main/docs/memoria_tecnica_global_proyecto.md). |
...
| [Guía de despliegue en VM de GCP](../scripts/guia_implementacion_vm_gcp_almacenes.txt) | Despliegue en una VM de Google Cloud (modo producción o modo prueba): crear la VM, firewall de VPC, IP/DNS, swap, ejecución y validación. Incluye limpieza y registro de hallazgos en modo prueba. |
...
> y se actualiza la memoria técnica del módulo afectado + la
> [memoria técnica global](https://github.com/davidreyna1974/almacenes/blob/main/docs/memoria_tecnica_global_proyecto.md)
> (en el repo paraguas `almacenes`).
